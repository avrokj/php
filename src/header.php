<header class="flex bg-gray-200 dark:bg-slate-800 shadow rounded-t-lg grid grid-cols-3 p-4 sticky top-0">
  <div class="flex items-center">
    <img src="./assets/book.png" alt="Raamatud" class="h-12 w-12 mr-2">
    <a href="./">
  ...
  <div class="flex justify-center items-center">
    <form action="./search.php" method="post" class="max-w-[480px] w-full px-4">
      <div class="relative">
        <input type="text" name="keyword" id="" placeholder="Sisesta raamatu nimi..." class="w-full dark:bg-slate-500 border dark:border-cyan-600 h-12 shadow p-4 rounded-full">
  ...
  <div class="text-right self-center">
    ...
    if (stripos($_SERVER['REQUEST_URI'], 'book') !== false || stripos($_SERVER['REQUEST_URI'], 'edit') !== false) {
      ...
      echo "Meil on <strong>$total_rows</strong> raamatut.";
    }; ?>
  </div>
</header>